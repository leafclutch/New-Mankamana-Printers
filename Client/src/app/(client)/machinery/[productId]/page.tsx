...
export default function MachineryOrderPage({ params }: { params: Promise<{ productId: string }> }) {
    ...
    return (
      <div className="min-h-[calc(100vh-72px)] bg-[#f8f7f4] flex items-center justify-center">
        <div className="text-center">
          ...
          <button type="button" onClick={() => router.push("/machinery")}
  ...
  const renderStep2 = () => (
    <div className="flex flex-col gap-5">
      <div>
        ...
        <p className="text-xs text-slate-400 mb-4">Upload your reference images or any files needed for this order. At least one file is required.</p>
        <div
                  ...
                  <div className="px-4 py-4 bg-white flex flex-col gap-2.5 text-sm">
                    ...
                    {paymentDetails.qrImageUrl && !failedPaymentQrById[paymentDetails.id] ? (
                      ...
                      <div className="mt-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-5 text-center">
                        <p className="text-[0.72rem] font-semibold uppercase tracking-[0.08em] text-slate-500">No preview available</p>
                      </div>
                    )}
                  </div>
                </div>
