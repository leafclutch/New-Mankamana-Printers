...
export default function MachineryGroupPage() {
    ...
    useEffect(() => {
        ...
        const key = `machinery-group-${groupId}`;
        const url = `${API_BASE}/machinery/groups/${groupId}`;
            ...
            <div className="max-w-6xl mx-auto px-5 sm:px-8 py-10">
                {loading ? (
                    ...
                    <div className="text-center py-24">
                        ...
                        <p className="text-slate-500 font-medium">Machinery group not found.</p>
                        <Link href="/machinery" className="mt-4 inline-block text-blue-600 text-sm font-semibold hover:underline">
                    ...
                    <div className="text-center py-24">
                        <div className="text-5xl mb-4">📦</div>
                        <p className="text-slate-500 font-medium">No models available in this group.</p>
